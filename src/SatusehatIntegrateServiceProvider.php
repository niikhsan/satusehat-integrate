...
class SatusehatIntegrateServiceProvider extends ServiceProvider
{
    public function boot()
    {
        ...
        $this->publishes([
            __DIR__.'/../database/seed/csv/icd10.csv.stub' => database_path('/seeders/csv/icd10.csv'),
        ], 'icd10');

        // Publish Seeder for ICD10
        if (! class_exists('Icd10Seeder')) {
            $this->publishes([
                __DIR__.'/../database/seed/Icd10Seeder.php.stub' => database_path('/seeders/Icd10Seeder.php'),
            ], 'icd10');
        }
